...
class RegistrationResponse(object):
    ...
    @property
    def auth_token(self):
        """Gets the auth_token of this RegistrationResponse.  # noqa: E501

        A token that should be use to authenticate the requests  # noqa: E501

        :return: The auth_token of this RegistrationResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def auth_token(self, auth_token):
        """Sets the auth_token of this RegistrationResponse.

        A token that should be use to authenticate the requests  # noqa: E501

        :param auth_token: The auth_token of this RegistrationResponse.  # noqa: E501
        :type: str
        """
